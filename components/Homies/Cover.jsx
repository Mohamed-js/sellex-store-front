      ...
      <div className="mx-auto">
        <div className="relative shadow-xl sm:overflow-hidden">
          ...
          <div 
            ...
            style={{ height: `${store.options.cover.height}`, textAlign: `${store.options.cover.content_horizontal_position}` }}
          >
            <p
              className=" relative left-0 right-0 mx-auto mt-5 max-w-xl  text-xl  font-semibold uppercase tracking-wide text-orange-600"
              style={{
            ...
            <h1 className="mt-6  font-bold uppercase text-gray-900 sm:text-5xl sm:tracking-tight lg:text-7xl">
              <span
                className="block"
                style={{
            ...
            <div style={{textAlign: `${store.options.cover.button.alignment}`}} className=" w-full mx-auto mt-10 max-w-xs sm:max-w-none">
              <button
